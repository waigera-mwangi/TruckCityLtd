    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.PositiveIntegerField(default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=10, verbose_name='Price')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('image', models.ImageField(upload_to='')),
                ('created_date', models.DateField(auto_now_add=True)),
                ('updated', models.DateField(auto_now=True, verbose_name='Updated')),
                ('in_stock', models.BooleanField(default=True, verbose_name='In stock')),
                ('category', models.ForeignKey(default='Wooden_poles', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pole_category', to='store.category')),
            ],
            options={
                'verbose_name': 'Pole',
