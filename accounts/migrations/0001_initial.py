    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CM', 'CUSTOMER'), ('DR', 'DRIVER'), ('IM', 'INVENTORY MANAGER'), ('SP', 'SERVICE PROVIDER'), ('SR', 'SUPPLIER'), ('IS', 'INSTALLER'), ('FM', 'FINANCE MANAGER'), ('AD', 'ADMIN')], default='CM', max_length=2)),
